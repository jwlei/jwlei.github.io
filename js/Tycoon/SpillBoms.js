class SpillBoms extends game {
    ...
    Lagre() {
        ...
        this.databaseRef.set({
            ...
            regler: this.regler,
            runde: this.runde,
            spillere: TycoonPlayer.getPlayers(this.spillere),
    ...
    StartSpillFix() {
        ...
        if (this.spillere.filter(s => (s.plassering != 0)).length > 0) {
            ...
            this.setSinTur(null);
            if (this.spillere.length >= 5) {
                this.spillere[0].melding.push("Skal gi to card til bomsen.");
                this.spillere[1].melding.push("Skal gi ett card til visebomsen.");
                this.spillere[this.spillere.length - 2].melding.push("Gir sitt d̴rligste card til visepresidenten.");
                this.spillere[this.spillere.length - 1].melding.push("Gir sine to d̴rligste card til presidenten.");
                this.spillBunke = [{
    ...
    NesteSinTur_Neste(varSinTur) {
        ...
        if (this.SpillBunkeGarUt(info)) {
            ...
            //if (typeof spillerSist.playedLastTurn == "KortBunke") {
